...
#define SHARP_SS 26
#define SHARP_DISP 25

Adafruit_SharpMem *display = new Adafruit_SharpMem(SHARP_SCK, SHARP_MOSI, SHARP_SS, DISP_W, DISP_H);
Arduino_Canvas_Graphics2D *canvas = new Arduino_Canvas_Graphics2D(DISP_W, DISP_H, display);
